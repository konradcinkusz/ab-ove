...
\begin{figure}[ht]
\centering
\includegraphics[width=0.78\linewidth]{../diagrams/rendered/b1-reader-loop.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.92\linewidth]{../diagrams/rendered/a3-one-origin.pdf}
...
Five phases, ranked in \code{docs/ux/UI-UX.md} so that a delivery session picks up a decision
...
\begin{description}[leftmargin=0pt,itemsep=1pt]
  \item[\code{docs/START-HERE.md}] The front door, in English and Polish: which of the four
  ...
  \item[\code{docs/DIAGRAMS.md}] The whole system as diagrams, in four parts, in English and
        Polish. Each one exists inline --- the only form GitHub renders --- and as a
        standalone \code{.mmd} that this paper's figures are rendered from.
  \item[\code{docs/SCREENSHOTS.md}] The product screen by screen, in English and Polish,
        captured from a production build by the acceptance suite.
  \item[\code{docs/tutorials/}, \code{docs/how-to/}] Bilingual throughout: the lessons for a
