...
| `reveal-working.spec.ts` | the frame after a reveal offers what the reader worked out on the frame it answers — the pad's lines and the sketch, read from this browser and sent nowhere — offers nothing when there is nothing, and moves nothing when it arrives, turned to or loaded (#168) |
