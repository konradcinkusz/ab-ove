...
export interface Progress {
  /**
   * The frame this browser last showed, and so the program an index offers one control for.
   * Only its program is read back: the frame offered is that program's furthest.
   */
