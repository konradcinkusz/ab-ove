 ...
 *
 * ──────────────────────────────────────────────────────────────────────────────────────
 * ADR-0048. ONE CONTROL, AT THE TOP, ENGLISH UNTIL SOMEBODY SAYS OTHERWISE, REMEMBERED.
 *
 ...
 *
 * ENGLISH IS THE DEFAULT AND THAT IS A REVERSAL, argued in ADR-0048 against ADR-0015. The
